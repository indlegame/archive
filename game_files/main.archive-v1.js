              ...
              this.shadowRoot.appendChild(Sa.content.cloneNode(!0)),
                (this.shadowRoot.querySelector("#hash").textContent =
                  null === (e = window.indle) || void 0 === e
                    ...
                    : e.hash),
			    //Commented French in INDLE
                //(this.shadowRoot.querySelector("#language-button").textContent = window.localStorage.getItem("indle-language") == "fr" ? "English" : "Français"),
...
/*                 (this.shadowRoot.querySelector("#language-setting").textContent =
                  window.localStorage.getItem("indle-language") == "fr" ? "Langue : Français" : "Language: English"),
                (this.shadowRoot.querySelector("#language-button").addEventListener("click", function () {
                    var currentLanguage = window.localStorage.getItem("indle-language");
                    window.localStorage.setItem("indle-language", currentLanguage == "fr" ? "en" : "fr");
                    saveArchiveNoApp();
          ...
          o(t, [
            {
              ...
              value: function () {
				...
				"Begum is a royal and aristocratic title from Central and South Asia which usually means 'higher official'. In South Asia, particularly in Delhi, Hyderabad, Sindh, Punjab, Afghanistan, Khyber Pakhtunkhwa and Bengal, begum has been adapted for use as an honorific for Muslim women of high social status, accomplishment, or rank.", /*11 begum*/
				...
				"A dosas is a thin flat bread originating from South India, made from a fermented batter predominantly consisting of lentils and rice, with savoury flavours generally emphasized. There are over a 100 varities of Dosas in India. ", /*14 dosas*/
				...
				"According to the Botanical Survey of India, India is home to more than 8,000 species of medicinal plants. The country has a rich history of traditional healing systems, many of which list the use of these plants.", /*16 herbs*/
				...
				//Commented TWITTER DIV in INDLE
	/*                 var twitter = document.createElement("div");

					if (window.localStorage.getItem("indle-language") == "fr") {
					  twitter.innerHTML = '<p align="center">Découvrez <a href="https://www.twitter.com/IndleGame" target="_blank">@IndleGame</a> sur Twitter!</p>';  
					} else {
					  twitter.innerHTML = '<p align="center">Check out <a href="https://www.twitter.com/IndleGame" target="_blank">@IndleGame</a> on Twitter!</p>';
					}
